    ...
    return (
        <div className={'vacancy-card'}>
            ...
            <div className={'vacancy-card-title-container'}>
                <a target="_blank" className={'vacancy-card-title-container__title'} href={'https://www.yandex.ru'}>{title}</a>
            </div>
            <div className={'vacancy-card-content'}>
                <div className={'vacancy-card-content-info'}>
                    <a target="_blank" className={'vacancy-card-content-info__link'} href={'https://www.yandex.ru'}>{city}</a>
                    <img className={'vacancy-card-content-info__image'} src={EllipseIcon} alt={'ellipse-icon'} />
                    <a target="_blank" className={'vacancy-card-content-info__link'} href={'www.yandex.ru'}>{companyName}</a>
                </div>
